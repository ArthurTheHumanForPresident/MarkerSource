    ...
    IntroTagColor = '800080' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Scribbles', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'Arthur The Human', 300, -305-IntroTagWidth, 260)
