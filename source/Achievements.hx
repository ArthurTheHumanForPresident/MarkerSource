...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Purple marker",					"Find purple marker",	'purple',				 false],
		["Red marker",					"Find red marker",	'red',				 false],
		["Ghost marker",					"Find ghost marker",	'ghost',				 false],
		["Sus marker",					"Find sus marker",	'sus',				 false],
		["Serenity marker",					"Find serenity marker",	'serenity',				 false],
		["Greedy marker",					"Find greedy marker",	'greedy',				 false],
		["Cheese marker",					"Find cheese marker",	'cheese',				 false],
		["Difficulty chart marker",					"Find difficulty chart marker",	'difficulty',				 false],
		["Khaki marker",					"Find khaki marker",	'khaki',				 false]
	];
